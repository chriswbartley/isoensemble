...
These examples show how to fit a model using IsoRandomForestClassifier.
 `IsoRandomForestClassifier` first fits a forest ensemble using `sci-kit learn's`
...
import numpy as np
import isoensemble as isoensemble
...
###############################################################################
# Fit a IsoRandomForestClassifier model
# -------------------------
