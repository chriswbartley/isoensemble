...
# -*- coding: utf-8 -*-
#
# isoensemble documentation build configuration file, created by
...
htmlhelp_basename = 'isoensembledoc'
...
latex_documents = [
  ('index', 'isoensemble.tex', 'isoensemble Documentation',
...
man_pages = [
    ('index', 'isoensemble', 'isoensemble Documentation',
...
texinfo_documents = [
  ('index', 'isoensemble', 'isoensemble Documentation',
   'Christopher Bartley', 'isoensemble', 'One line description of project.',
   'Miscellaneous'),
]
